  ...
  return (
    <div className="maxw">
      {country ? (
        ...
        <div className="relative cursor-default select-none flex flex-col pt-20 items-center text-gray-700 dark:text-white">
          <p>Nothing found.</p>
          <button className="shadow-[0_1px_5px_2px_rgba(0,0,0,0.1)] bg-white dark:bg-DM-Elements  px-8">
